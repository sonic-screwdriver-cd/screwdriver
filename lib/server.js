...
module.exports = (config) => {
    ...
    return registrationMan(server, config)
        .then(() => {
            ...
            server.app.buildFactory.tokenGen = (buildId, metadata, scmContext, expiresIn) => server.plugins.auth.generateToken(server.plugins.auth
            ...
            server.app.jobFactory.tokenGen = (username, metadata, scmContext) => server.plugins.auth.generateToken(server.plugins.auth
