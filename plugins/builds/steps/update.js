                        ...
                        .then(step => {
                            if (!step) {
                                ...
                                if (request.payload.code !== undefined) {
                                    ...
                                    steps[stepIndex].endTime =
                                        request.payload.endTime || now;
                                } else if (
                                    request.payload.lines !== undefined
                                ) {
                                    steps[stepIndex].lines =
                                        request.payload.lines;
                                } else {
                                    steps[stepIndex].startTime =
                                        request.payload.startTime || now;
                                }
