                ...
                this.getJwt(this.apiToken)
                    ...
                    .then(response => {
                        ...
                        for (let i = 0; i < expectedJobs.length; i += 1) {
                            ...
                            Assert.ok(
                                job,
                                "Given job does not exist on pipeline"
                            );
    ...
    When(
        ...
        function step(branch) {
            return github
                ...
                .then(() =>
                    github.createFile(branch, this.repoOrg, this.repoName)
                )
                .then(({ data }) => {
    ...
    Then(
        ...
        function step(triggeredJobName, parentJobName) {
            return sdapi
                ...
                .then(builds => {
                    this.builds = builds;
                    const parentJob = this.jobs.find(
                        j => j.name === parentJobName
                    );
        ...
        function step(joinJobName, parentJobName1, parentJobName2) {
            return sdapi
                ...
                .then(builds => {
                    ...
                    const joinBuild = this.builds.find(
